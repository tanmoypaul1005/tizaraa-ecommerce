  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className={`w-full cursor-pointer py-4 px-6 rounded-xl font-semibold text-base transition-all flex items-center justify-center gap-2 ${
          isAvailable
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className={`py-3 cursor-pointer px-4 rounded-xl border-2 font-medium transition-all flex items-center justify-center gap-2 ${
            isInWishlist
        ...
        <div className="relative z-50">
          <button
            ...
            type="button"
            className="w-full cursor-pointer py-3 px-4 rounded-xl border-2 border-gray-300 text-gray-700 font-medium hover:border-gray-400 hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
          >
